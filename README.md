...
This project is being modified for windows machines, and also to include text based generation of rooms.  The following is the readme from the original author, Chris Paris.
